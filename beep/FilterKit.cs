...
namespace beep
{
    ...
    public class FilterKit
    {
        ...
        private static readonly double IzeroEPSILON = 1E-21;
         ...
         * @return
         */
        public static float lrsFilterUp(float[] Imp, float[] ImpD, int Nwing, bool Interp, float[] Xp_array, int Xp_index, double Ph,
                int Inc)
        {
            double a = 0;
            float v, t;
         ...
         * @return
         */
        public static float lrsFilterUD(float[] Imp, float[] ImpD, int Nwing, bool Interp, float[] Xp_array, int Xp_index, double Ph,
                int Inc, double dhb)
        {
            float a;
            float v, t;
